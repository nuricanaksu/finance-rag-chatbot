...
/* Modal */
.info-overlay { position: fixed; top: 0; left: 0; width: 100%; height: 100%;
 background-color: rgba(0,0,0,0.8); display: flex; align-items: center;
 justify-content: center; z-index: 9999; }
.info-modal { background-color: #FFFFFF; color: #0D1117; padding: 2rem;
 border-radius: 12px; max-width: 600px; box-shadow: 0 0 20px rgba(0,0,0,0.3); }
.info-close { background-color: #00E6A8; color: white; border: none;
 border-radius: 6px; padding: 0.5rem 1.2rem; cursor: pointer;
 margin-top: 1rem; font-weight: 600; }
.info-close:hover { background-color: #00C690; }
